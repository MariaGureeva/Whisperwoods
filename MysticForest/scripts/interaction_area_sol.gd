...
func get_pre_quest_dialogue():
	return [
		{ "speaker": "Sol", "text": "Hmph. Don't talk to me. We've lost our harmony." },
		{ "speaker": "Sol", "text": "The Singing Totems around the pond are silent... There can be no song without them." }
	]

func get_post_quest_dialogue():
	return [
		{ "speaker": "Sol", "text": "The pond sings again! Thank you, Listener!" }
	]
